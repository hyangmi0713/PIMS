				...
				<div>
					<div class="btn-group mr-2" style="padding-left: 250px; padding-top: 50px;">
						<%
							...
							String[] btnname = {"A1","A3","A4","B4","B5","LTR","LDR","EXEC","STMT","A6"};
							int btnsize = btnname.length;
							String selectedPaper;
							
							for(int i=0; i<btnsize;i++){
						%>
							<button class="btn btn-inverse btn<%=i+1%>" id="btncheck<%= btnname[i] %>" name="btncheck<%= btnname[i] %>" onclick="btncheck('<%= btnname[i] %>');"><%= btnname[i] %></button>
...
function btncheck(btnname){
	...
	$.ajax({
		...
		url: 'http://10.1.2.180:8080/PIMS/home_data.jsp',
		type : 'POST',
...
$(document).ready(function(){
	$(".btn1").on("click", function(){
		...
		$(".btn2").removeClass("activebtn");
		$(".btn3").removeClass("activebtn");
		$(".btn4").removeClass("activebtn");
		$(".btn5").removeClass("activebtn");
		$(".btn6").removeClass("activebtn");
		$(".btn7").removeClass("activebtn");
		$(".btn8").removeClass("activebtn");
		$(".btn9").removeClass("activebtn");
		$(".btn10").removeClass("activebtn");
	});
	$(".btn2").on("click", function(){
		$(this).addClass("activebtn");
		$(".btn1").removeClass("activebtn");
		$(".btn3").removeClass("activebtn");
		$(".btn4").removeClass("activebtn");
		$(".btn5").removeClass("activebtn");
		$(".btn6").removeClass("activebtn");
