...
<%
	...
	int getUserPartNo = partListDAO.selPartNo(department);
	
	ProjectDAO projectDAO = new ProjectDAO();
	ArrayList<Project> getProjectList = projectDAO.allPartProjectList1();

	int result = pm_inventoryDAO.addExpaperInput(expaper, department, userName, getUserPartNo);
	//int resultPaperStock = paperStockDAO.updatePaperStock(expaper, getProjectList, 1);
	...
	if (result == -1)
	{
		...
		script.println("location.href='expenditure.jsp'");
		script.println("</script>");
	}
	else 
	{
