...
<body>	
	<nav class="navbar navbar-default">
        ...
        <div class="container">
            <h2><img src="images\storage.png"
                alt="My Image" width="90">&nbsp;&nbsp;용지 재고</h2>
            <p>용지 재고를 표시합니다.  </p>
            
            							<div id="canvas-holder" style="width:1150px">
											<canvas id="chart-area" style="width: 1150px; height: 500px; display: block;"></canvas>
										</div>
										<div>
											...
											<div class="btn-group mr-2" style="padding-left:250px; padding-top:50px;">
												...
												<!-- btn-inverse btn-success btn-primary btn-warning btn-danger-->
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-12" style="text-align: center;">
                        <h5>All contents Copyright 2020 </h5>
                        <h5>CKBS CHOI MINHO</h5>
                    </div>
                </div>
            </div>    
        </footer>
