...
<head>
	<meta charset="utf-8">
	<meta name="viewport" content="width=device-width" intial-scale="1" intial-scale="1">
	<title>Canon 용지 재고 관리 프로그램 - 출고화면</title>
					...
					<table width="98%" class="type10" style="font-size:10pt;">
						<thead>
							<tr>
								...
								<th width="150" style="text-align:center;">용지종류</th>
								<th width="150" style="text-align:center;">평량(g/m)</th>
								<th width="150" style="text-align:center;">용지이름</th>
								<th width="150" style="text-align:center;">출고 수량(Pack)</th>
						...
						<input type="hidden" value="<%=getUserPart %>" id="part" >
					</table>
					...
					<table width="98%" class="type10" id="dynamicTable" style="font-size:10pt;">
						<thead>
							<tr>
								...
								<th style="text-align:center;">출고 수량(Pack)</th>
...
<script> 
	...
	function tableCreate() {
		...
		/* else if (document.getElementById("kind").value == "") {
		...
		else if (document.getElementById("size" && "kind" && "gram" && "paperName" && "count" && "projectSel").value != "") {
			...
			expaper_sub[5] = projectNo;
			expaper_sub[6] = projectName;
			expaper_sub[7] = note;
	...
	function inputCreate(part, name) {
		...
		inputCreateForm.action = "ecpenditureAction.jsp";
