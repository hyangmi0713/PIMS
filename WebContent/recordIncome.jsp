					...
					<table width="98%" class="type10" style="font-size:10pt;">
						<thead>
							<tr>
								...
								<th scope="cols" style="text-align:center;">입고 수량</th>
								<th scope="cols" style="text-align:center;">입고 부서</th>
								<th scope="cols" style="text-align:center;">프로젝트</th>
								<th scope="cols" style="text-align:center;">입고자 소속</th>
						...
						<tbody>
							...
							if(pageNumber == 0) {
								...
								if (pageStartNumberIncome+9 < getIncomeDAO.size()) {
									pageEndNumberIncome = pageStartNumberIncome+10;
								}
								else {
									pageEndNumberIncome = getIncomeDAO.size();
								}
							}
							else {
							...
							%>
								<tr class="first">
									...
									<td style="padding-top:15px; text-align:center; "><%=getIncomeDAO.get(i).getPaper_inv_date() %></td>
									<td style="padding-top:15px; text-align:center; "><%=getIncomeDAO.get(i).getPaper_inv_size() %></td>
									<td style="padding-top:15px; text-align:center; "><%=getIncomeDAO.get(i).getPaper_inv_kind() %></td>
									<%
									if(!getIncomeDAO.get(i).getPaper_inv_gram().equals("-")) {
									%>
									<td style="padding-top:15px; text-align:center; "><%=getIncomeDAO.get(i).getPaper_inv_gram() %> m/g</td>
									<%
									}
									else {
									%>
									...
									%>
									<td style="padding-top:15px; text-align:center; "><%=getIncomeDAO.get(i).getPaper_inv_name() %></td>
									<td style="padding-top:15px; text-align:center; "><%=getIncomeDAO.get(i).getPaper_inv_quantity() %> Pack</td>
									<td style="padding-top:15px; text-align:center; "><%=getIncomeDAO.get(i).getPaper_inv_request() %></td>
									<td style="padding-top:15px; text-align:center; "><%=getIncomeDAO.get(i).getPaper_project() %></td>
									<td style="padding-top:15px; text-align:center; "><%=getIncomeDAO.get(i).getMem_no() %></td>
									<td style="padding-top:15px; text-align:center; "><%=getIncomeDAO.get(i).getMen_derpartment() %></td>
									<td style="padding-top:15px; text-align:center; "><%=getIncomeDAO.get(i).getPaper_inv_note() %></td>
							...
							%>
								<tr class="first">
									...
									<td class="even" style="padding-top:15px; text-align:center; "><%=getIncomeDAO.get(i).getPaper_inv_date() %></td>
									<td class="even" style="padding-top:15px; text-align:center; "><%=getIncomeDAO.get(i).getPaper_inv_size() %></td>
									<td class="even" style="padding-top:15px; text-align:center; "><%=getIncomeDAO.get(i).getPaper_inv_kind() %></td>
									<%
									if(!getIncomeDAO.get(i).getPaper_inv_gram().equals("-")) {
									%>
									<td class="even" style="padding-top:15px; text-align:center; "><%=getIncomeDAO.get(i).getPaper_inv_gram() %> m/g</td>
									<%
									}
									else {
									%>
									...
									%>
									<td class="even" style="padding-top:15px; text-align:center; "><%=getIncomeDAO.get(i).getPaper_inv_name() %></td>
									<td class="even" style="padding-top:15px; text-align:center; "><%=getIncomeDAO.get(i).getPaper_inv_quantity() %> Pack</td>
									<td class="even" style="padding-top:15px; text-align:center; "><%=getIncomeDAO.get(i).getPaper_inv_request() %></td>
									<td class="even" style="padding-top:15px; text-align:center; "><%=getIncomeDAO.get(i).getPaper_project() %></td>
									<td class="even" style="padding-top:15px; text-align:center; "><%=getIncomeDAO.get(i).getMem_no() %></td>
									<td class="even" style="padding-top:15px; text-align:center; "><%=getIncomeDAO.get(i).getMen_derpartment() %></td>
									<td class="even" style="padding-top:15px; text-align:center; "><%=getIncomeDAO.get(i).getPaper_inv_note() %></td>
								...
								<td colspan="11">
									<table style="margin-left: auto; margin-right: auto;">
										<tr>
											...
											<%
											if (getIncomeDAO.size()/10 < 10) {
												for (int j=0; j<(getIncomeDAO.size()/10+1); j++) {
													if (j==pageNumber) {
											%>
														<b><%=j+1 %>&nbsp;</b>
											<%
											...
											<%
												...
												if (pageNumber-3 <= 0) {
													...
													if (pageNumber+6 > (getIncomeDAO.size()/10)) {
														totalPageStartNum = pageNumber-(9-((getIncomeDAO.size()/10)-pageNumber));
														totalPageEndNum = (getIncomeDAO.size()/10)+1;
													}
													else {
											...
											<td style="text-align: left;">
												<a href="javascript:void(0);" onClick="movePage('<%=(getIncomeDAO.size()/10) %>'); return false;"><img src="images/nextIcon.png"></a>
											</td>
										</tr>
										<%pageNumber = 0; %>
									</table>
